...
COMMENT ON TABLE "public"."profiles" IS 'Names of application users';
...
CREATE POLICY "Grant all privilege to authenticated users only" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Grant all privileges to authorized users only" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
